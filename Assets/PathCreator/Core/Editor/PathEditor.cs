                ...
                if (data.showPathOptions)
                {
                    ...
                    if (data.showTransformTool)
                    {
                        ...
                        if (GUILayout.Button("Add new point"))
                        {
                            ...
                            if (!isCtrlDown) newPathPoint = bezierPath[bezierPath.NumPoints - 1] + (Vector3.forward * 50);
                            else newPathPoint = bezierPath[0] + (bezierPath[0].normalized * 100);
                            ...
                            handleIndexToDisplayAsTransform = bezierPath.NumPoints - 1;
                            Repaint();
                        }
                        ...
                        if (GUILayout.Button("Remove last point"))
                        {
                            ...
                            if (bezierPath.NumPoints < 1)
                                Debug.LogError("PathEditor: no points left to delete!");
                            else
                                bezierPath.DeleteSegment(bezierPath.NumPoints - 1);
                        ...
                        if (handleIndexToDisplayAsTransform != -1)
                        {
                            if (GUILayout.Button("Remove this point"))
                                bezierPath.DeleteSegment(handleIndexToDisplayAsTransform);
                        }
