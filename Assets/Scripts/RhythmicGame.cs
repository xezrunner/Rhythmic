...
public class RhythmicGame
{
    ...
    public int slowdown_ramp_ticks = 960;
    ...
    public static void SetResolution(Vector2 resolution) { Screen.SetResolution((int)resolution.x, (int)resolution.y, FullScreenMode.FullScreenWindow); DebugUI.Instance?.Start(); }
    ...
    public static float HorizonMeasuresOffset = 40f; // How many units to offset (backwards) from the horizon when clipping
